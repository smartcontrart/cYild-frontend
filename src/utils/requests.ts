...
export const fetchParaswapRoute = async (
  ...
  try {
    ...
    if (response_json && response_json.txParams && response_json.priceRoute) {
      ...
      response_json &&
      response_json.error === "No routes found with enough liquidity"
    ) {
      return { success: false, data: "not enough liquidity" };
    } else if (
      response_json &&
      response_json.error.indexOf("too small to proceed") > -1
    ) {
...
export const sendClosePositionReport = async (
  ...
  try {
    const response = await fetch(
      `${BACKEND_API_URL}/positions/${positionId}/close`,
      {
        method: "POST",
        headers: {
...
export const getMaxSlippageForPosition = async (
  ...
  try {
    const response = await fetch(
      `${BACKEND_API_URL}/positions/${positionId}/maxSlippage`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export const updateMaxSlippageForPosition = async (
  ...
  try {
    const response = await fetch(
      `${BACKEND_API_URL}/positions/${positionId}/updateMaxSlippage`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const updateTickBuffers = async (
  ...
  try {
    const response = await fetch(
      `${BACKEND_API_URL}/positions/${positionId}/updateTickBuffers`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
